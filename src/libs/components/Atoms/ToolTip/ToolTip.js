...
export var ToolTip = function ToolTip(props) {
  var children = props.children,
      ...
      _props$limitLines = props.limitLines,
      limitLines = _props$limitLines === void 0 ? 5 : _props$limitLines,
      otherProps = _objectWithoutProperties(props, ["children", "content", "primary", "limitLines"]);
  ...
  return React.createElement(StyledToolTipWrapper, _extends({
    ...
    onClick: function onClick() {
      return setState(!tooltipVisible);
    }
  }, otherProps), children, tooltipVisible && content && React.createElement(StyledToolTip, {
    primary: primary
