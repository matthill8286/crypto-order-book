...
export var AssetTileListItem = function AssetTileListItem(_ref) {
  var _ref$orientation = _ref.orientation,
      orientation = _ref$orientation === void 0 ? 'landscape' : _ref$orientation,
      props = _objectWithoutProperties(_ref, ["orientation"]);

  return React.createElement(AssetTileGridItem, _extends({
    orientation: orientation
  }, props));
};
//# sourceMappingURL=AssetTileListItem.js.map